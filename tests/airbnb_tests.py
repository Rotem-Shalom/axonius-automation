...
def test_validate_search_and_get_highest_and_cheapest_items(setup_search):
...
def test_validate_search_and_reservation_details(setup_search, page):
    results_page = setup_search
    assert consts.TEST_CITY in results_page.get_page_heading_text()
